...
student_status = student_status_options[0]

level_of_study_options = {0: "", 1: "Undergraduate", 2: "Graduate"}
level_of_study = level_of_study_options[1]

degree_options = {0: "", 1: "Master's", 2: "PhD"}
degree = degree_options[0]

correlation_threshold = 0.7# Minimum threshold for correlation
...
stats_header = [["Question", "Sample Size", "Mean", "Median", "Standard Deviation", "Skew"]]
